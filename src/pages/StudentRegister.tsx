  ...
  const handleRegistration = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to VITERN! You can now access your dashboard."
      });
      setIsLoading(false);
    }, 2000);
  };
        ...
        <Card className="card-elevated">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">
              ...
              {step === 3 && "Tell us about yourself to complete registration"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {step === 3 && (
              <form onSubmit={handleRegistration} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="experience" className="text-foreground font-medium">Experience</Label>
                  <Textarea
                    id="experience"
